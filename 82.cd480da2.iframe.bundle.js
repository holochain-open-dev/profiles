...
`,chunk_TUVJKY7S=__webpack_require__("./node_modules/@shoelace-style/shoelace/dist/chunks/chunk.TUVJKY7S.js"),chunk_4TUIT776=__webpack_require__("./node_modules/@shoelace-style/shoelace/dist/chunks/chunk.4TUIT776.js"),chunk_KAW7D32O=__webpack_require__("./node_modules/@shoelace-style/shoelace/dist/chunks/chunk.KAW7D32O.js"),class_map=__webpack_require__("./node_modules/lit/directives/class-map.js"),decorators=__webpack_require__("./node_modules/lit/decorators.js"),chunk_F4NP2SRV_SlSkeleton=class extends chunk_4TUIT776.f{constructor(){super(...arguments),this.effect="none"}render(){return lit.qy`
    ...
    `}renderProfile(profile){return profile?lit__WEBPACK_IMPORTED_MODULE_1__.qy`
      <div class="column">
        ...
        ${this.noAdditionalFields?lit__WEBPACK_IMPORTED_MODULE_1__.qy``:Object.entries(this.getAdditionalFields(profile.entry)).filter((([,value])=>""!==value)).map((([key,value])=>this.renderAdditionalField(key,value)))}
      </div>
    `:lit__WEBPACK_IMPORTED_MODULE_1__.qy`<div
        class="column"
        style="align-items: center; justify-content: center; flex: 1;"
      >
        <span class="placeholder"
          >${(0,_lit_localize__WEBPACK_IMPORTED_MODULE_4__.ab)("This agent hasn't created a profile yet")}</span
        >
      </div>`}render(){if(!this._agentProfile.value)return lit__WEBPACK_IMPORTED_MODULE_1__.qy`
        <div class="column">
          <div class="row" style="align-items: center">
            <sl-skeleton
              effect="pulse"
      ...
      `;switch(this._agentProfile.value.status){case"pending":return lit__WEBPACK_IMPORTED_MODULE_1__.qy`
          <div class="column">
            <div class="row" style="align-items: center">
              <sl-skeleton
                effect="pulse"
            ...
            ${this.store.config.additionalFields.map((()=>lit__WEBPACK_IMPORTED_MODULE_1__.qy`
                <sl-skeleton
                  effect="pulse"
