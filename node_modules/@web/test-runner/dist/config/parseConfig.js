...
async function parseConfig(config, cliArgs = {}) {
    ...
    if (finalConfig.coverageConfig) {
        finalConfig.coverageConfig = deepmerge_1.default(defaultCoverageConfig, finalConfig.coverageConfig);
    }
    else {
    ...
    finalConfig.plugins.unshift(plugins_1.setViewportPlugin(), plugins_1.emulateMediaPlugin(), plugins_1.setUserAgentPlugin());
