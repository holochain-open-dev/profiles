import * as lit_html_lib_template_result from 'lit-html/lib/template-result';
import * as lit_element_lib_css_tag from 'lit-element/lib/css-tag';
...
declare class Card extends LitElement {
    ...
    static styles: lit_element_lib_css_tag.CSSResult;
    /**
     * Used to render the lit-html TemplateResult to the element's DOM
     */
    render(): lit_html_lib_template_result.TemplateResult;
    /**
