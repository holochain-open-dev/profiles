...
var Chaperone = /** @class */ (function () {
    ...
    Chaperone.prototype.init = function (timeout) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var admin_ws, cell_ids, arbitrary_cell, dna_hash, agent_id, seedValid;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        log('Initializing mode is set to: %s (%s)', this.mode, mode_map[this.mode]);
                        if (!(this.mode === Chaperone.HCC)) return [3 /*break*/, 5];
                        if (!(this.opts.web_user_legend !== undefined)) return [3 /*break*/, 1];
                        this.agent_overrides = this.opts.web_user_legend;
                        return [3 /*break*/, 5];
                    case 1:
                        if (!this.opts.hcc_admin_port) return [3 /*break*/, 4];
                        log("Getting agent ID from admin interface ws://localhost:" + this.opts.hcc_admin_port);
                        return [4 /*yield*/, conductor_api_1.AdminWebsocket.connect("ws://localhost:" + this.opts.hcc_admin_port)];
                    case 2:
                        admin_ws = _b.sent();
                        return [4 /*yield*/, admin_ws.listCellIds()];
                    case 3:
                        cell_ids = _b.sent();
                        log("Got cell IDs from admin interface: " + cell_ids);
                        arbitrary_cell = cell_ids[0];
                        dna_hash = arbitrary_cell[0], agent_id = arbitrary_cell[1];
                        this.agent_id = util_1.Codec.AgentId.encode(agent_id);
                        log("Setting agent ID = " + this.agent_id);
                        return [3 /*break*/, 5];
                    case 4:
                        if (this.opts.agent_id === undefined) {
                            log('WARNING: this Chaperone has no configured users');
                        }
                        _b.label = 5;
                    case 5:
                        if (!this.agent_id && this.opts.agent_id) {
                        ...
                        if (!(this.mode === Chaperone.DEVELOP || this.mode === Chaperone.HCC)) return [3 /*break*/, 6];
                        ...
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, this.getHhaHash()];
                    case 7:
                        _b.sent();
                        _b.label = 8;
                    case 8:
    ...
    Chaperone.prototype.createAnonymousAgent = function () {
        this.anonymous = true;
        if (this.mode === Chaperone.HCC && this.opts.hcc_admin_port) {
            log('Skipping anonymous agent generation in favor of autodetected agent ID');
            return;
        }
        try {
    ...
    Chaperone.prototype.deriveAgent = function (email, password) {
        ...
        this.anonymous = false;
        if (this.mode === Chaperone.HCC && this.opts.hcc_admin_port) {
            log('Skipping deriveAgent in favor of autodetected agent ID');
            return;
        }
