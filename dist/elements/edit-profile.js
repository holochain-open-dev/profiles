 ...
 */
let EditProfile = class EditProfile extends ScopedElementsMixin(LitElement) {
    constructor() {
        super(...arguments);
    ...
    firstUpdated() {
        ...
        this._nicknameField.validityTransform = (newValue) => {
            ...
            if (newValue.length < this.store.config.minNicknameLength) {
                ...
                this._nicknameField.setCustomValidity(msg('This nickname already exists'));
                return { valid: false };
            }
            return {
                valid: true,
        ...
        <div class="column">
          ...
          <div class="row" style="justify-content: center; margin-bottom: 8px; align-self: start;" >
            ...
            <mwc-textfield
              ...
              .helper=${msg(str `Min. ${this.store.config.minNicknameLength} characters`)}
          ...
          <mwc-button
            ...
            .label=${(_b = this.saveProfileLabel) !== null && _b !== void 0 ? _b : msg('Save Profile')}
